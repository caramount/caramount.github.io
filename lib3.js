...
function gl_update(gl) {
   ...
   gl.uniform3fv (uVar('lColor'),   lColor);
   gl.uniform4fv (uVar('uSpheres'), uSpheres);
   gl.uniform3fv (uVar('ambient'),  ambient);
   gl.uniform3fv (uVar('diffuse'),  diffuse);
   gl.uniform3fv (uVar('specular'), specular);
   gl.uniform1f  (uVar('power'),    power);
